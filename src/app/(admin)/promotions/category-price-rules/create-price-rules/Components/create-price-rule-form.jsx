...
import { customSelectStyles, formatIDRCurrency, mapToSelectOptions, toLocalDateString, unformatIDR } from '@/utils/other'
...
const schema = Yup.object().shape({
    ...
    discountValue: Yup.string().trim().min(1, 'Discount Value is required').max(20, 'Discount Value cannot exceed 20 numbers').required('Discount Value is required'),
...
export default CreatePriceRuleForm
