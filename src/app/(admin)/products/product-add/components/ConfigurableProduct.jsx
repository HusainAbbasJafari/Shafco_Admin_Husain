...
import { useAttributes } from '@/services/productServices';
...
const ConfigurableProduct = ({ attributeSetOptions, geColorOptions, brandOptions, categoryOptions }) => {
  ...
  const handleImageUpload = async (data) => {
    try {
      ...
      imageData.forEach((item, index) => {
        ...
        formData.append("ProductVariantId", item?.productVariantId || "");
        formData.append("ProductImage", item.image);
        formData.append("ProductImageName", item?.image?.name || "");
            ...
            <Row>
              ...
              <Col lg={4}>
                <div className="mb-3">
                  ...
                  <input type="number" id="product-stock" className="form-control" placeholder="Quantity" {...register("sellingprice")} />
